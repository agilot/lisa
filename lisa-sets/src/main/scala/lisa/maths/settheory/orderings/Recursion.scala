...
//               val singletonMembership = have(in(t, singleton(pr)) <=> (t === pr)) by Weakening(singletonMembership of (y -> t, x -> pr))
...
//               val singletonMembership = have(in(t, singleton(pr)) <=> (t === pr)) by Tautology.from(singletonMembership of (y -> t, x -> pr))
...
//                       have(pair(b, a) === pair(pr, F(uw))) by Tautology.from(singletonMembership of (y -> pair(b, a), x -> pair(pr, F(uw))))
...
//                       singletonMembership of (x -> pair(pr, F(uw)), y -> pair(pr, F(uw)))
//                     )
